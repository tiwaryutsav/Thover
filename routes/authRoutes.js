...
router.get("/get-admin",protect,authController.fetchAllAdmins);
...
router.post("/get-connectionto-count", protect, authController.getUserConnectionsCount);
router.post("/get-connectionfrom-count", protect, authController.getUserConnection_fromCount);
